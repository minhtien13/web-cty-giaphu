    ...
    <form action="" method="POST">
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" name="title" value="{{ $post->title }}" class="form-control" placeholder="Tiêu đề bài viết">
          <input type="text" name="is_link" hidden value="{{ $post->is_link }}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="d-none" value="{{ $post->thumb }}" name="thumb" id="thumb">
        ...
        <div class="form-group">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="is_status" value="1" id="yes_active" {{ $post->is_status == 1 ? 'checked' : '' }}>
                <label class="form-check-label" for="yes_active">
                    Công Khai
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" value="0" name="is_status" id="no_active" {{ $post->is_status == 0 ? 'checked' : '' }}>
